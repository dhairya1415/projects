...
def import_data(data_file):
    ...
    for row in attendee_data:
        ...
        generate_pdf(event_name, event_venue, no_of_participants, event_department ,image, event_description, event_date, pdf_file_name)

def generate_pdf(event_name, event_venue, no_of_participants, event_department, image, event_description, event_date, pdf_file_name):
    ...
    c.drawCentredString(4.135*inch, 10.50*inch, "-----------------------------------------------------------")
    c.setFont("Helvetica", 15, leading=None)
    c.drawString(0.4*inch, 9.69*inch, "Event Department: {}".format(event_department))
    c.drawString(0.4*inch, 9.19*inch, "Event Venue: {}".format(event_venue))
    c.drawString(0.4*inch, 8.69*inch, "No. of participants: {}".format(no_of_participants))
