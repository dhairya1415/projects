...
def create_mail(
    EventName, EventStartDate, EventEndDate, teacher_name, event_obj
    ...
    body = "Here is the report for the event {} which was held between {} to {}".format(EventName, EventStartDate, EventEndDate)
...
def send_mail(filename, teacher_name, event_obj):
    ...
    EventStartDate = eventDetail_list[1]
    EventEndDate = eventDetail_list[2].split(".")[0]
    # get the email object
    email = create_mail(EventName, EventStartDate, EventEndDate, teacher_name, event_obj)
