...
urlpatterns = [
    ...
    path("event/<int:month>/<int:year>", views.event_list, name="month_request"), # Month data
    path("user/<str:first>", views.user_list, name="profile"), # user profile data
    path("event/<str:date>", views.event_date, name="date_request"), #Event data based on month
